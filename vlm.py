...
def post_processing_viz(result, depth_frame, intr, img_path='temp/vl_now.jpg', check=False):
    '''
    ...
    try:
        ...
        # 将像素坐标转换为相机坐标
        x_cam_end, y_cam_end, z_cam_end = rs.rs2_deproject_pixel_to_point(intrinsics,
                                                                          [END_X_CENTER, END_Y_CENTER],
                                                                          end_depth)
        ...
        return x_cam_end, y_cam_end, z_cam_end, x_cam_start, y_cam_start, z_cam_start
